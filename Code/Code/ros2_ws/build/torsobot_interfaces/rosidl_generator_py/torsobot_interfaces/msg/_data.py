...
class Data(metaclass=Metaclass_Data):
    ...
    def __init__(self, **kwargs):
        ...
        self.wheel_pitch = kwargs.get('wheel_pitch', float())
        ...
        self.motor_acc = kwargs.get('motor_acc', float())
    ...
    def __eq__(self, other):
        ...
        if self.torso_pitch != other.torso_pitch:
            return False
        if self.wheel_pitch != other.wheel_pitch:
            return False
        ...
        if self.motor_vel != other.motor_vel:
            return False
        if self.motor_acc != other.motor_acc:
            return False
        return True
    ...
    def wheel_pitch(self):
        """Message field 'wheel_pitch'."""
        return self._wheel_pitch

    @wheel_pitch.setter
    def wheel_pitch(self, value):
        if self._check_fields:
            assert \
                isinstance(value, float), \
                "The 'wheel_pitch' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'wheel_pitch' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._wheel_pitch = value
    ...
    @builtins.property
    def motor_acc(self):
        """Message field 'motor_acc'."""
        return self._motor_acc

    @motor_acc.setter
    def motor_acc(self, value):
        if self._check_fields:
            assert \
                isinstance(value, float), \
                "The 'motor_acc' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'motor_acc' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._motor_acc = value
