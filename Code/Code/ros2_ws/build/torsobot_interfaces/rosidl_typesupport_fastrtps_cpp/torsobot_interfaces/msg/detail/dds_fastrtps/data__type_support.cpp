...
#include "torsobot_interfaces/msg/detail/data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const torsobot_interfaces::msg::Data & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  torsobot_interfaces::msg::Data & ros_message)
{
  // Member: torso_pitch
  cdr >> ros_message.torso_pitch;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = torsobot_interfaces::msg::Data;
    is_plain =
      (
      offsetof(DataType, motor_current) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const torsobot_interfaces::msg::Data *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<torsobot_interfaces::msg::Data *>(
    untyped_ros_message);
...
{
  return &torsobot_interfaces::msg::typesupport_fastrtps_cpp::_Data__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, torsobot_interfaces, msg, Data)() {
  return &torsobot_interfaces::msg::typesupport_fastrtps_cpp::_Data__handle;
}
