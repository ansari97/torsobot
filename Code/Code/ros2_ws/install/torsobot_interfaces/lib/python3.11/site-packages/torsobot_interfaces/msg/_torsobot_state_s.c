...
bool torsobot_interfaces__msg__torsobot_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("torsobot_interfaces.msg._torsobot_state.TorsobotState", full_classname_dest, 53) == 0);
  }
  torsobot_interfaces__msg__TorsobotState * ros_message = _ros_message;
  {  // torso_pitch
...
{
  /* NOTE(esteve): Call constructor of TorsobotState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("torsobot_interfaces.msg._torsobot_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TorsobotState");
