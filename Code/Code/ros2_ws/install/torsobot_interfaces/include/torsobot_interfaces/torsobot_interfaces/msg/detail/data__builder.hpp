...
class Init_Data_motor_acc
{
public:
  explicit Init_Data_motor_acc(::torsobot_interfaces::msg::Data & msg)
  : msg_(msg)
  {}
  ::torsobot_interfaces::msg::Data motor_acc(::torsobot_interfaces::msg::Data::_motor_acc_type arg)
  {
    msg_.motor_acc = std::move(arg);
...
class Init_Data_motor_vel
{
public:
  explicit Init_Data_motor_vel(::torsobot_interfaces::msg::Data & msg)
  : msg_(msg)
  {}
  Init_Data_motor_acc motor_vel(::torsobot_interfaces::msg::Data::_motor_vel_type arg)
  {
    msg_.motor_vel = std::move(arg);
    return Init_Data_motor_acc(msg_);
  }
...
class Init_Data_motor_pos
{
public:
  explicit Init_Data_motor_pos(::torsobot_interfaces::msg::Data & msg)
  : msg_(msg)
  {}
  Init_Data_motor_vel motor_pos(::torsobot_interfaces::msg::Data::_motor_pos_type arg)
  {
    msg_.motor_pos = std::move(arg);
    return Init_Data_motor_vel(msg_);
  }
...
public:
  ...
  : msg_(msg)
  {}
  Init_Data_motor_pos motor_current(::torsobot_interfaces::msg::Data::_motor_current_type arg)
  {
    msg_.motor_current = std::move(arg);
    return Init_Data_motor_pos(msg_);
  }
