...
PID_controller.kp = 0.8; %(4.7/(desired_settling_period*0.8))^2;
PID_controller.ki = 0.00; % removed I = 0.05 term and added gravity compesnation for the torso angle
PID_controller.kd = 0.08; %2*1*(4.7/(desired_settling_period*0.8));
...
controller_param.phi_desired = deg2rad(15);
